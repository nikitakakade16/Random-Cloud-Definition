...
# List of cloud-related definitions (replace with your actual definitions)
definitions = [
...
# Function to insert definitions into DynamoDB
def insert_definitions():
    for definition in definitions:
        table.put_item(Item=definition)
    print("Definitions inserted successfully!")
